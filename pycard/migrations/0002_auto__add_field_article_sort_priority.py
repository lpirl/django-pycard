...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.sort_priority'
        db.add_column(u'pycard_article', 'sort_priority',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.sort_priority'
        db.delete_column(u'pycard_article', 'sort_priority')
